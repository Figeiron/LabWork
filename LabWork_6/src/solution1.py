...
def brut_force_equation(func):  # задамо ф-цію для перебору значень з заданим рівнянням котре задається безіменною ф-цією
    for x in range(1, number):  # переберемо всі можливі числа
